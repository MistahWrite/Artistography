...
//
$_CONFIG['secondary_titles'] = array("Artistography FTP Uploads");
...
//
$_CONFIG['hidden_files'] = array("README.txt", ".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd");
...
<form enctype="multipart/form-data" method="post">
	...
	<input type="text" name="user_name" value="admin" id="user_name" />
	<?php print $this->getString("password"); ?>:
	<input type="password" name="user_pass" value="admin" id="user_pass" />
